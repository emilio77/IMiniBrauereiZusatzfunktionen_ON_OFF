...
const unsigned char kreis_leer[8] =
{  
  B00000000,
  B11111000,
  B10001000,
...
const unsigned char kreis_voll[8] =
{  
  B00000000,
  B11111000,
  B11111000,
...
void DisplayOut() {
  ...
  if (state[1]=='o') { display.drawBitmap(49, 0, officon, 16, 16, 1); }        
  else if (state[1]=='x') { display.drawBitmap(49, 0, stopicon, 16, 16, 1);}
  else if (state[1]=='y') { display.drawBitmap(49, 0, playicon, 16, 16, 1);}
  else if (state[1]=='z') { display.drawBitmap(49, 0, pauseicon, 16, 16, 1); }

  if (jetztMillis<displayMillis+5000)
  {
    if (Funktionslog[1]==true) { display.drawBitmap(0, 24, kreis_voll, 8, 8, 1); } else { display.drawBitmap(0, 24, kreis_leer, 8, 8, 1); }  
    if (Funktionslog[2]==true) { display.drawBitmap(12, 24, kreis_voll, 8, 8, 1); } else { display.drawBitmap(12, 24, kreis_leer, 8, 8, 1); }  
    if (Funktionslog[3]==true) { display.drawBitmap(24, 24, kreis_voll, 8, 8, 1); } else { display.drawBitmap(24, 24, kreis_leer, 8, 8, 1); }  
    if (Funktionslog[4]==true) { display.drawBitmap(36, 24, kreis_voll, 8, 8, 1); } else { display.drawBitmap(36, 24, kreis_leer, 8, 8, 1); }  
    if (Funktionslog[5]==true) { display.drawBitmap(48, 24, kreis_voll, 8, 8, 1); } else { display.drawBitmap(48, 24, kreis_leer, 8, 8, 1); }  
    if (Funktionslog[6]==true) { display.drawBitmap(0, 32, kreis_voll, 8, 8, 1); } else { display.drawBitmap(0, 32, kreis_leer, 8, 8, 1); }  
    if (Funktionslog[7]==true) { display.drawBitmap(12, 32, kreis_voll, 8, 8, 1); } else { display.drawBitmap(12, 32, kreis_leer, 8, 8, 1); }  
    if (Funktionslog[8]==true) { display.drawBitmap(24, 32, kreis_voll, 8, 8, 1); } else { display.drawBitmap(24, 32, kreis_leer, 8, 8, 1); }  
    if (Funktionslog[9]==true) { display.drawBitmap(36, 32, kreis_voll, 8, 8, 1); } else { display.drawBitmap(36, 32, kreis_leer, 8, 8, 1); }  
    if (Funktionslog[10]==true) { display.drawBitmap(48, 32, kreis_voll, 8, 8, 1); } else { display.drawBitmap(48, 32, kreis_leer, 8, 8, 1); }  
    display.setCursor(0,0);
    display.println("Funktion");
    display.println();
    display.println("1 2 3 4 5");
    display.println();
    display.println();
    display.println("6 7 8 9 0");
    display.display();
  }
  ...
  else if (jetztMillis<displayMillis+9000 & ( FunktionText1!="" || FunktionText2!="" || FunktionText3!="" ) )
  {
    ...
    display.println();
    display.println(FunktionText1);
    display.println(FunktionText2);
    display.println(FunktionText3);
    display.display();
  }
